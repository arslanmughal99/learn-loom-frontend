...
const MyLearning: NextPage<MyLearningProps> = () => {
  const tabs = useMemo<
    {
      href: string;
      name: string;
  ...
  return (
    <main>
      {/* <div className="bg-foreground/70 h-[200px]" /> */}
      ...
      <div className="relative max-w-7xl mx-auto lg:h-[calc(100vh-500px)] overflow-y-auto">
